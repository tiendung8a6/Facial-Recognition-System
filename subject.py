...
class Subject:
    def __init__(self, root):
        ...
        lbl = Label(
            self.root, font=("yu gothic ui", 13, "bold"), bg="white", fg="black"
        )
        ...
        auttendanceID_entry = ttk.Entry(
            left_inside_frame,
            state="disabled",
            textvariable=self.var_subid,
            font=("times new roman", 12, "bold"),
            width=22,
        )
        ...
        nameLabel_entry = ttk.Entry(
            left_inside_frame,
            width=22,
            textvariable=self.var_subclass,
            font=("times new roman", 12, "bold"),
        )
        ...
        Right_frame = LabelFrame(
            Left_frame, bg="white", bd=0, font=("times new roman", 12, "bold")
        )
        ...
        label_teachersb = Label(
            Underleft_frame,
            bg="white",
            fg="red2",
            text="Môn học của giảng viên",
        ...
        search_combo = ttk.Combobox(
            Underleft_frame,
            font=("times new roman", 12, "bold"),
            textvariable=self.var_com_searchtc,
            state="read only",
            width=12,
        )
        ...
        searchtc_entry = ttk.Entry(
            Underleft_frame,
            textvariable=self.var_searchtc,
            width=13,
        ...
        showAlltc_btn = Button(
            Underleft_frame,
            text="Xem tất cả",
            command=self.fetch_Tcdata,
            font=("times new roman", 11, "bold"),
            bg="#38a6f0",
            fg="white",
            width=10,
        ...
        # id
        self.var_teachersub.trace(
            "w",
            lambda name, index, mode, var_teachersub=self.var_teachersub: self.callback(),
        )
        ...
        teacherid_entry = ttk.Entry(
            Underleft_frame,
            textvariable=self.var_teachersub,
            font=("times new roman", 12, "bold"),
            width=20,
        )
        ...
        teachernLabel_entry = ttk.Entry(
            Underleft_frame,
            width=20,
            textvariable=self.var_teachername,
            font=("times new roman", 12, "bold"),
            state="disabled",
        )
        ...
        # subject
        self.var_subsub.trace(
            "w", lambda name, index, mode, var_subsub=self.var_subsub: self.callsubtc()
        )
        subsub_label = Label(
            Underleft_frame,
            text="ID môn học:",
        ...
        subsub_entry = ttk.Entry(
            Underleft_frame,
            width=22,
            textvariable=self.var_subsub,
            font=("times new roman", 12, "bold"),
        )
        ...
        subjectnameLabel_entry = ttk.Entry(
            Underleft_frame,
            width=22,
            textvariable=self.var_subjectname,
            font=("times new roman", 12, "bold"),
            state="disabled",
        )
        ...
        label_studentsb = Label(
            Underright_frame,
            bg="white",
            fg="red2",
            text="Môn học của sinh viên",
            font=("yu gothic ui", 14, "bold"),
        )
        ...
        searchstd_entry = ttk.Entry(
            Underright_frame,
            textvariable=self.var_searchstd,
            width=13,
            font=("times new roman", 11, "bold"),
        )
        searchstd_entry.grid(row=0, column=1, padx=5, pady=35, sticky=W)

        searchstd_btn = Button(
            Underright_frame,
            command=self.search_Stddata,
            text="Tìm kiếm",
            font=("times new roman", 11, "bold"),
            bg="#38a6f0",
            fg="white",
        ...
        showAllstd_btn = Button(
            Underright_frame,
            text="Xem tất cả",
            command=self.fetch_Stddata,
            font=("times new roman", 11, "bold"),
            bg="#38a6f0",
            fg="white",
            width=10,
        ...
        # student
        self.var_studentsub.trace(
            "w",
            lambda name, index, mode, var_studentsub=self.var_studentsub: self.callstudent(),
        )
        ...
        studentid_entry = ttk.Entry(
            Underright_frame,
            textvariable=self.var_studentsub,
            font=("times new roman", 12, "bold"),
            width=20,
        )
        ...
        # subject
        self.var_subsubst.trace(
            "w",
            lambda name, index, mode, var_subsubst=self.var_subsubst: self.callstSub(),
        )
        subsub_label = Label(
            Underright_frame,
            text="ID Môn học:",
        ...
        subsub_entry = ttk.Entry(
            Underright_frame,
            width=22,
            textvariable=self.var_subsubst,
            font=("times new roman", 12, "bold"),
        )
        subsub_entry.place(x=130, y=165, width=100)
        ...
        studentname_entry = ttk.Entry(
            Underright_frame,
            textvariable=self.var_stSubname,
            font=("times new roman", 12, "bold"),
            width=12,
            state="disabled",
        )
    ...
    def add_data(self):
        ...
        # =========check subject============
        my_cursor.execute(
            "select Subject_name from `subject` where Class=%s",
        ...
        if (
            self.var_subid.get() == "Select"
            or self.var_subclass.get() == ""
            or self.var_subname.get() == ""
        ):
            messagebox.showerror(
                "Error", "Vui lòng nhập đầy đủ thông tin", parent=self.root
            )
        elif self.var_subname.get() in arraySub:
            messagebox.showerror(
                "Error",
                "Lớp học đã có môn học này! Vui lòng kiểm tra lại",
                parent=self.root,
            )
        elif self.var_subclass.get() not in arrayClass:
            messagebox.showerror(
                "Error",
                "Tên lớp học không tồn tại ! Vui lòng kiểm tra lại",
                parent=self.root,
            )
        elif self.var_subid.get() in arraySubject:
            messagebox.showerror(
                "Error",
                "Đã tồn tại mã môn học ! Vui lòng kiểm tra lại",
                parent=self.root,
            )
        else:
            try:
                ...
                conn.close()
                messagebox.showinfo(
                    "Thành công", "Thêm thông tin môn học thành công", parent=self.root
                )
        ...
        if (
            ...
            try:
                Update = messagebox.askyesno(
                    "Update",
                    "Bạn có muốn cập nhật bản ghi này không?",
                    parent=self.root,
                )
                if Update > 0:
                    conn = mysql.connector.connect(
                    ...
                    my_cursor = conn.cursor()
                    my_cursor.execute(
                        "update subject set Subject_name=%s,Class=%s"
                        " where Subject_id=%s",
                        (
                            self.var_subname.get(),
                            self.var_subclass.get(),
        ...
        if self.var_subid == "":
            ...
            try:
                delete = messagebox.askyesno(
                    "Xoá bản ghi", "Bạn có muốn xóa bản ghi này ?", parent=self.root
                )
                if delete > 0:
                    conn = mysql.connector.connect(
                        host="localhost",
        ...
        if self.var_com_search.get() == "" or self.var_search.get() == "":
            ...
            try:
                ...
                if len(data) != 0:
                    ...
                    messagebox.showinfo(
                        "Thông báo",
                        "Có " + str(len(data)) + " bản ghi thỏa mãn điều kiện",
                    )
                    conn.commit()
                else:
                    self.AttendanceReportTable.delete(
                    ...
                    messagebox.showinfo(
                        "Thông báo", " Không có bản ghi nào thỏa mãn điều kiện"
                    )
                conn.close()
            except Exception as es:
                messagebox.showerror("Lỗi", f"Due To:{str(es)}", parent=self.root)
    ...
    def add_Tcdata(self):
        ...
        # =========check subject============
        my_cursor.execute(
            "select Subject_id from teacher_has_subject where Teacher_id=%s",
            (self.var_teachersub.get(),),
        )
        ckSubject = my_cursor.fetchall()
        arraySub = []
        ...
        my_cursor.execute(
            "select COUNT(Teacher_id) from `teacher_has_subject` where Subject_id=%s",
            (self.var_subsub.get(),),
        )
        ...
        if self.var_teachersub.get() == "" or self.var_subsub.get() == "":
            ...
            messagebox.showerror(
                "Error",
                "Giảng viên đã có môn học này! Vui lòng kiểm tra lại",
                parent=self.root,
            )
        elif ckTeacher_has1sub[0] > 0:
            messagebox.showerror(
                "Error",
                "Môn học này đã có giảng viên! Vui lòng kiểm tra lại",
                parent=self.root,
            )
        elif self.var_teachersub.get() not in arrayTeacher:
            messagebox.showerror(
                "Error",
                "ID Giảng viên không tồn tại! Vui lòng kiểm tra lại",
                parent=self.root,
            )
        elif self.var_subsub.get() not in arraySubject:
            messagebox.showerror(
                "Error",
                "ID Môn học không tồn tại! Vui lòng kiểm tra lại",
                parent=self.root,
            )
        else:
            try:
                ...
                my_cursor = conn.cursor()
                my_cursor.execute(
                    "insert into teacher_has_subject values(%s,%s)",
                    (
                        self.var_teachersub.get(),
                        self.var_subsub.get(),
                    ),
                ...
                messagebox.showinfo(
                    "Thành công",
                    "Thêm thông tin môn học cho giảng viên thành công",
                    parent=self.root,
                )
            except Exception as es:
                messagebox.showerror("Error", f"Due To:{str(es)}", parent=self.root)
        ...
        if self.var_teachersub == "" or self.var_subsub.get() == "":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    my_cursor = conn.cursor()
                    my_cursor.execute(
                        "UPDATE `teacher_has_subject` SET `Teacher_id` = %s, `Subject_id` = %s WHERE "
                ...
                messagebox.showinfo(
                    "Thành công",
                    "Cập nhật thông tin môn học GV thành công",
                    parent=self.root,
                )
                conn.commit()
                self.reset_Tcdata()
    ...
    def delete_Tcdata(self):
        if self.var_teachersub == "" or self.var_subsub.get() == "":
            messagebox.showerror(
                "Lỗi", "Không được bỏ trống thông tin! ", parent=self.root
            )
        else:
            try:
                delete = messagebox.askyesno(
    ...
    def search_Tcdata(self):
        if self.var_com_searchtc.get() == "" or self.var_searchtc.get() == "":
            ...
            try:
                ...
                my_cursor.execute(
                    "select * from teacher_has_subject where "
                    + str(self.var_com_searchtc.get())
                    + " Like '%"
                    + str(self.var_searchtc.get())
                    + "%'"
                )
                data = my_cursor.fetchall()
                if len(data) != 0:
    ...
    def add_Stddata(self):
        ...
        # =========check subject============
        my_cursor.execute(
            "select Subject_id from student_has_subject where Student_id=%s",
            (self.var_studentsub.get(),),
        )
        ckSubject = my_cursor.fetchall()
        arraySub = []
        ...
        if self.var_studentsub == "" or self.var_subsubst.get() == "":
            ...
            messagebox.showerror(
                "Error",
                "Sinh viên đã có môn học này! Vui lòng kiểm tra lại",
                parent=self.root,
            )
        elif self.var_studentsub.get() not in arrayStudent:
            messagebox.showerror(
                "Error",
                "ID Sinh viên không tồn tại! Vui lòng kiểm tra lại",
                parent=self.root,
            )
            ...
            try:
                ...
                my_cursor = conn.cursor()
                my_cursor.execute(
                    "insert into student_has_subject values(%s,%s)",
                    (
                        self.var_studentsub.get(),
                        self.var_subsubst.get(),
                    ),
                ...
                messagebox.showinfo(
                    "Thành công",
                    "Thêm thông tin môn học cho sinh viên thành công",
                    parent=self.root,
                )
            except Exception as es:
                messagebox.showerror("Error", f"Due To:{str(es)}", parent=self.root)
        ...
        if self.var_studentsub == "" or self.var_subsubst.get() == "":
            ...
            try:
                ...
                if Update > 0:
                    ...
                    my_cursor = conn.cursor()
                    my_cursor.execute(
                        "UPDATE `student_has_subject` SET `Student_id` = %s, `Subject_id` = %s WHERE "
                ...
                messagebox.showinfo(
                    "Thành công",
                    "Cập nhật thông tin môn học Sinh viên thành công",
                    parent=self.root,
                )
                conn.commit()
                self.reset_Stddata()
    ...
    def search_Stddata(self):
        if self.var_com_searchstd.get() == "" or self.var_searchstd.get() == "":
            ...
            try:
                ...
                my_cursor.execute(
                    "select * from student_has_subject where "
                    + str(self.var_com_searchstd.get())
                    + " Like '%"
                    + str(self.var_searchstd.get())
                    + "%'"
                )
                data = my_cursor.fetchall()
                if len(data) != 0:
